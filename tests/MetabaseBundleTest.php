...
class MetabaseBundleTest extends TestCase
{
    ...
    {
        $linkGenerator = new UrlGenerator('http://example.org', 'secret');

        $this->assertEquals(
            'http://example.org/embed/question/eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJyZXNvdXJjZSI6eyJxdWVzdGlvbiI6MX0sInBhcmFtcyI6e30sImV4cCI6eyJkYXRlIjoiMjAyNC0wMS0wMSAwMDowMDowMS4wMDAwMDAiLCJ0aW1lem9uZV90eXBlIjozLCJ0aW1lem9uZSI6IlVUQyJ9fQ.TV7zfbC7U0TZ_hdV98YkWvTVZ7wd93kyLT1swxAjKO4',
    ...
    public function testLinkGeneratorForDashboard(): void
    {
        ...
        $this->assertEquals(
            'http://example.org/embed/dashboard/eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJyZXNvdXJjZSI6eyJkYXNoYm9hcmQiOjF9LCJwYXJhbXMiOnsiaWQiOjF9LCJleHAiOnsiZGF0ZSI6IjIwMjQtMDEtMDEgMDA6MDA6MDEuMDAwMDAwIiwidGltZXpvbmVfdHlwZSI6MywidGltZXpvbmUiOiJVVEMifX0.Kr-y21F0wztFeEha_1LIUasDApBlh3Wze_CE_0cNe_U',
